        ...
        <div className="content-container">
          ...
          <div className="highlight-content">
            ...
            <div className="right-container">
              ...
              <div className="furni-subspace subtitle">{furnitureData.space_cat}</div>
              <div className="text-format">
                <div className="key">Sub Space Category</div>
                <div className="value">: &nbsp;&nbsp;{furnitureData.sub_space_cat}</div>

                <div className="key">Furniture Type</div>
                <div className="value">: &nbsp;&nbsp;{furnitureData.furni_type}</div>

                <div className="key">Dimension</div>
                <div className="value">: &nbsp;&nbsp;{furnitureData.furni_dimension[0]} x {furnitureData.furni_dimension[1]} x {furnitureData.furni_dimension[2]} mm</div>

                <div className="key">Style</div>
                <div className="value">: &nbsp;&nbsp;{furnitureData.furni_style}</div>
